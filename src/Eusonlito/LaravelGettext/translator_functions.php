 ...
 * @return string
 */
function _n($original, $plural, $value)
{
 ...
 * @return string
 */
function _dp($domain, $context, $original)
{
 ...
 * @return string
 */
function _np($context, $original, $plural, $value)
{
 ...
 * @return string
 */
function _dnp($domain, $context, $original, $plural, $value)
{
